...
public partial class CycleOfLife : IAsyncDisposable
{
    [Inject] private IJSRuntime JSRuntime { get; set; } = default!;

    private List<LifecycleLogEntry> lifecycleLog = [];
    ...
    private DotNetObjectReference<CycleOfLife>? dotNetReference;
        ...
        if (firstRender)
        {
            ...
            try
            {
                ...
                jsModule = await JSRuntime.InvokeAsync<IJSObjectReference>(
                    "import", 
                    "./Components/Features/CycleOfLife/CycleOfLife.razor.js",
